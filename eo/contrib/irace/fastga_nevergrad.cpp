...
int main(int argc, char* argv[])
{
    ...
    const size_t dimension = problem->meta_data().n_variables;
    ...
    problem->attach_logger(loggers);

    /*****************************************************************************
     * Binding everything together.
     *****************************************************************************/

    eoEvalIOHproblem<Bits> onemax_pb(*problem, loggers);
